...
PRED_DIR="/scratch/project_2001426/stringdata/blocklists-paper/auto-org-predictions/"
mkdir -p $PRED_DIR
cp ${OUTPUT_DIR}"/output_with_probabilities_dict.tsv" "/scratch/project_2001426/stringdata/blocklists-paper/auto-org-predictions/output_with_probabilities_"$(basename ${DATASET_DIR##*-})".tsv"

echo -n 'result written in /scratch/project_2001426/stringdata/blocklists-paper/auto-org-predictions'$'\n'
seff $SLURM_JOBID
