...
mkdir -p output-biobert/predictions/ggp-blocklists-v12
...
for dataset in $(ls $data_dir); do
    if [[ "${dataset##*./}" =~ ${NAME} ]]; then
        ...
        for model in $MODELS; do
            ...
            while true; do
                jobs=$(ls output-biobert/predictions/ggp-blocklists-v12 | wc -l)
            ...
            touch output-biobert/predictions/ggp-blocklists-v12/$job_id;
            sleep 5
        done
    fi
done
