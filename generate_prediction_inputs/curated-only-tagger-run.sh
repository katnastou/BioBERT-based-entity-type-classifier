...
monitor_job_completion "$job_name" "$USER" sbatch slurm-create-matches.sh dictionary-files-tagger-STRINGv12/all_entities.tsv curated-only/all_matches.tsv curated-only/database_matches.tsv
if [ ! -f "/scratch/project_2001426/stringdata/stringdata-v12/tagger_input_docs/database_documents.tsv" ]; then
    monitor_job_completion "$job_name" "$USER" sbatch slurm-create-docs.sh dictionary-files-tagger-STRINGv12/excluded_documents.txt 'gzip -cd `ls -1 /scratch/project_2001426/stringdata/stringdata-v12/tagger_input_docs/pmc/*.en.merged.filtered.tsv.gz` `ls -1r /scratch/project_2001426/stringdata/stringdata-v12/tagger_input_docs/pubmed/*.tsv.gz` |' /scratch/project_2001426/stringdata/stringdata-v12/tagger_input_docs/database_documents.tsv
fi

ln -s /scratch/project_2001426/stringdata/stringdata-v12/tagger_input_docs/database_documents.tsv curated-only/database_documents.tsv
