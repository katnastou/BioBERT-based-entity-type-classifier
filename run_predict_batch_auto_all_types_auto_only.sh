...
for TYPE in $TYPES; do
    ...
    NAME="${TYPE}-contexts-w100-[1-2][0-9][0-9].tsv"
    PRED_DIR="/scratch/project_2001426/stringdata/blocklists-paper/auto-only/${TYPE}-predictions"
    JOB_DIR="output-biobert/predictions/${TYPE}-blocklists-auto-only"
    mkdir -p "$JOB_DIR"
